...
export const DELIVERED_DIMENSIONS = {
  ...
  city_istanbul_kadikoy_pier: [13.12, 8.0, 8.45],
  ...
  city_bolu_yedigoller_lake: [111.87, 24.0, 111.73],
  ...
  kit_deer: [1.2, 2.8, 3.4],
  kit_pistachio: [5.33, 5.0, 5.36],
  ...
  city_izmir_celsus_facade: [3.68, 5.0, 1.56],
  city_izmir_theatre_seats: [4.17, 2.4, 4.2],
  city_izmir_clock_tower_base: [5.25, 4.2, 5.45],
  city_izmir_nazar_tree: [3.96, 3.8, 3.73],
  city_izmir_boyoz_cart: [1.67, 2.4, 1.44],
  ...
  city_izmir_ephesus: [87.49, 20.0, 92.17],
  city_izmir_gulf_shore: [86.46, 12.0, 86.43],
  city_izmir_clock_tower: [12.26, 18.0, 12.26],
  kit_izmir_doves_ruin: [4.1, 2.0, 4.09],
